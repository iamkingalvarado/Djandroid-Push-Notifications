...
class ModelTest(TestCase):
	...
	def test_gcmessage_todict(self):
		...
		jsondict = json.loads('{"delay_while_idle": true, "collapse_key": "key1", "time_to_live": 1100, "datadata1": {"payload_text": "test1"}, "dry_run": true}')
		msgdict = msg.to_dict()
		self.assertEqual(msgdict, jsondict)

	def test_accesstogcm(self):
		post_data = {REGISTRATION_IDS:[settings.GCM_TEST_ID], "delay_while_idle": True, "collapse_key": "key1", "time_to_live": 1100, "data": {"payload_text": "Hola mundo!"}} 
